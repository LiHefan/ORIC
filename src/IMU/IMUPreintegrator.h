...
public:
    ...
    inline Eigen::Matrix3d getDeltaR() const //R_k+1 = R_k*exp(w_k*dt)
    {
        return _delta_R;
    }

    // jacobian of delta measurement w.r.t bias of gyro/acc
    ...
    // exponential map from vec3 ti mat3*3 (Rodrigues formula)
...
private:
    ...
    Eigen::Matrix3d _delta_R;   // R_k+1 = R_k*exp(w_k*dt)
    ...
    //noise covariance propafation of delta measurements
